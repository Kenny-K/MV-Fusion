...
def parse_config():
    ...
    parser.add_argument('--tcp_port', type=int, default=16523)
    parser.add_argument('--local_rank', type=int, default=0)
    parser.add_argument('--sync_bn', action='store_true', default=False)
    parser.add_argument('--tag', type=str, default='default_tag')
    parser.add_argument('--onlyval', action='store_true', default=False)
    parser.add_argument('--saveval', action='store_true', default=False)
...
global_args, global_cfg = parse_config()
